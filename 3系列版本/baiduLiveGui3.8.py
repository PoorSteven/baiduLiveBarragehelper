...
class BaiduLive(QMainWindow):
    ...
    def instant_send(self):
        ...
        if CDKEY == 'OK':
            try:
                ...
                if os.path.isfile('instantComments.ini') == True:
                    os.remove('instantComments.ini')

                with open('instantComments.ini','a',encoding='utf-8')as f:
                    f.write(comment+'\n'+delay+'\n'+ckPath+'\n'+room_id)
                    f.close()
    ...
    def get_sendButton_click(self):
        ...
        if CDKEY == 'OK':
            ...
            if os.path.isfile('sendComments.ini') == True:
                os.remove('sendComments.ini')


            with open('sendComments.ini','a',encoding='utf-8')as f:
                f.write(ckPath+'\n'+adsPath+'\n'+roomID+'\n'+cycles+'\n'+delayFirst+'\n'+delayLast)
                f.close()
    ...
    def get_sendCaidan_click(self):
        ...
        if CDKEY == 'OK':
            ...
            try:
                ...
                if os.path.isfile('Eggshell.ini') == True:
                    os.remove('Eggshell.ini')

                with open('Eggshell.ini','a',encoding='utf-8')as f:
                    f.write(zancheck+'\n'+zanFisrt+'\n'+zanLast+'\n'+sharecheck+'\n'+shareFisrt+'\n'+shareLast+'\n'+followcheck+'\n'+followFirst+'\n'+followLast+'\n'+roomID+'\n'+ckPath)
                    f.close()
